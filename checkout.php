                      ...
                      <footer>
                        ...
                        <div class="form-group cheque">
                          <div class="ps-radio">
                            ...
                            <p>Đơn hàng sẽ giao đến bạn, bạn có thể kiểm tra ròi thanh toán với nhân viện giao hàng.</p>
                          </div>
                        </div>
                        <div class="form-group paypal">
                          <div class="ps-radio ps-radio--inline">
                            <input class="form-control" type="radio" name="payment" id="rdo02">
                            <label for="rdo02">ATM/Paypal</label>
                          </div>
                          <ul class="ps-payment-method">
                            ...
                            <button name="submit_payment" class="ps-btn ps-btn--fullwidth">THANH TOÁN<i class="ps-icon-next"></i></button>
                          <?php
