                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post mb-30">
                          ...
                          <div class="ps-post__content"><a class="ps-post__title" href="blog-detail.php">Bài viết demo</a>
                            <p class="ps-post__meta"><span>By:<a class="mr-5" href="blog.php">Đặng Hoàng Dương</a></span> -<span class="ml-5">07 - 12 -1999</span></p>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Id quas architecto est necessitatibus veniam dolor quisquam ullam voluptatum aspernatur ratione!/p><a class="ps-morelink" href="blog-detail.php">Xem thêm<i class="fa fa-long-arrow-right"></i></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
