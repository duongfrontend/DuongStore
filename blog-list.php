                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                  <div class="ps-post--2">
                    ...
                    <div class="ps-post__container">
                      <header class="ps-post__header"><a class="ps-post__title" href="blog-detail.php">Tiêu đề demo</a>
                        <p>Đăng bởi:  <a href="blog-grid.php">Đặng Hoàng Dương</a> 03 - 02 - 2023 <a href="blog-grid.php">Men Shoes</a> , <a href="blog-grid.php">Stylish</a></p>
                      </header>
                      <div class="ps-post__content">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet corrupti quas perspiciatis beatae distinctio! Qui ea nam distinctio aliquid, sed consectetur? Sequi quae doloribus ab odit, accusamus voluptas possimus ullam iste labore eligendi officiis saepe eveniet explicabo fugit. Non distinctio ut cum excepturi officia quod blanditiis omnis. Iure, praesentium voluptatum.</p>
                      </div>
                      <footer class="ps-post__footer"><a class="ps-post__morelink" href="#">Xem thêm<i class="ps-icon-arrow-left"></i></a>
