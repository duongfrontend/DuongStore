...
<div class="ps-cart__listing">
    ...
    <div class="ps-cart__total">
        <p>Số lượng sản phẩm:<span><?php echo $cartList->num_rows ?></span></p>
        <p>Giá:<span><?php echo $sumPrice ?> VND</span></p>
    </div>
    <div class="ps-cart__footer"><a class="ps-btn" href="cart.php">THANH TOÁN<i class="ps-icon-arrow-left"></i></a></div>
</div>
<?php
    }
?>